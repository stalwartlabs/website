...
Authorization determines what actions an authenticated user or entity may perform within the server. Where [authentication](/docs/auth/authentication/overview) establishes identity, authorization controls what that identity is allowed to do once verified.
