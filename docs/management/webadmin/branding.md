...
The branding feature in Stalwart allows administrators to apply custom logos, either globally or tailored to specific tenants and domains, across the web administration interface. The hierarchical logo selection process applies the most relevant branding based on the user's domain, providing consistency in multi-tenant setups.
