...
>
> Available variables: [`HttpVariable`](../expression/variable/http-variable.md).
...
This method requires the `sysHttpGet` [permission](../permissions.md).
...
This method requires the `sysHttpUpdate` [permission](../permissions.md).
...
- [`HttpVariable`](../expression/variable/http-variable.md) (Variables)
