...
This method requires the `sysApplicationGet` [permission](../permissions.md).
...
This operation requires the `sysApplicationCreate` [permission](../permissions.md).
...
This operation requires the `sysApplicationUpdate` [permission](../permissions.md).
...
This operation requires the `sysApplicationDestroy` [permission](../permissions.md).
...
This method requires the `sysApplicationQuery` [permission](../permissions.md).
