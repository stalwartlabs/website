...
This method requires the `sysSpamDnsblSettingsGet` [permission](../permissions.md).
...
This method requires the `sysSpamDnsblSettingsUpdate` [permission](../permissions.md).
