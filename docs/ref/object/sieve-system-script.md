...
This method requires the `sysSieveSystemScriptGet` [permission](../permissions.md).
...
This operation requires the `sysSieveSystemScriptCreate` [permission](../permissions.md).
...
This operation requires the `sysSieveSystemScriptUpdate` [permission](../permissions.md).
...
This operation requires the `sysSieveSystemScriptDestroy` [permission](../permissions.md).
...
This method requires the `sysSieveSystemScriptQuery` [permission](../permissions.md).
