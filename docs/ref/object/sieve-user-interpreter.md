...
This method requires the `sysSieveUserInterpreterGet` [permission](../permissions.md).
...
This method requires the `sysSieveUserInterpreterUpdate` [permission](../permissions.md).
...
### SieveCapability {#sievecapability}
