...
- A [coordination mechanism](/docs/cluster/coordination/overview), allowing nodes to communicate, share internal state, and remain synchronised. Stalwart supports peer-to-peer, Apache Kafka, NATS, and Redis.
