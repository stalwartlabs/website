...
Domains are configured through the [Domain](/docs/ref/object/domain) object (found in the WebUI under <!-- breadcrumb:Domain --><!-- /breadcrumb:Domain -->). Each record identifies a primary name and carries the settings that govern how the server handles mail and infrastructure for that name.
