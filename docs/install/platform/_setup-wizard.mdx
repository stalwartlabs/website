...
From the WebUI, open the Domain list (found in the WebUI under <!-- breadcrumb:Domain --><!-- /breadcrumb:Domain -->), click the three-dot menu next to the relevant domain, and select **View DNS Zone file**.
