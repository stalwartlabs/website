...
SASL authentication is configured on the [MtaStageAuth](/docs/ref/object/mta-stage-auth) singleton (found in the WebUI under <!-- breadcrumb:MtaStageAuth --><!-- /breadcrumb:MtaStageAuth -->). The relevant fields are:
