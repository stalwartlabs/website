...
Each hook is defined as an [MtaHook](/docs/ref/object/mta-hook) object (found in the WebUI under <!-- breadcrumb:MtaHook --><!-- /breadcrumb:MtaHook -->). The relevant fields are:
