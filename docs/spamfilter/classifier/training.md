...
Training samples are persisted as [SpamTrainingSample](/docs/ref/object/spam-training-sample) objects (found in the WebUI under <!-- breadcrumb:SpamTrainingSample --><!-- /breadcrumb:SpamTrainingSample -->), one per labelled message.
...
Training behaviour is configured on the [SpamClassifier](/docs/ref/object/spam-classifier) singleton (found in the WebUI under <!-- breadcrumb:SpamClassifier --><!-- /breadcrumb:SpamClassifier -->). The relevant fields are:
