...
Administrators can modify or remove these registered clients using either the [Webadmin](/docs/0.15/management/webadmin/overview) or [REST API](/docs/0.15/api/management/overview).
