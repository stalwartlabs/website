...
The default directory to authenticate [JMAP](/docs/http/jmap/overview), [IMAP](/docs/0.15/email/imap), [ManageSieve](/docs/sieve/managesieve) and HTTP API requests against can be configured using the `storage.directory` configuration attribute.
