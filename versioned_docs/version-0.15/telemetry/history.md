...
- `interval`: The time interval at which metrics data is sampled and stored in the history database. This value is specified as a [simple cron](/docs/0.15/configuration/values/cron) and the default is `0 * *`.
