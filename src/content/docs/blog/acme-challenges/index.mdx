...
description: "Today we announce the release of Stalwart Mail Server version 0.7.2, which now includes support for both DNS-01 and HTTP-01 ACME challenge types. This update marks a significant enhancement in our..."
authors: [mdecimus]
...
Stay tuned for more updates as we keep enhancing our mail server solutions. For detailed information on configuring and using the new challenge types in Stalwart Mail Server `0.7.2`, please refer to our [updated documentation](/docs/server/tls/acme/).
