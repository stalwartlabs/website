...
description: "Stalwart Mail Server continues its tradition of constant innovation and advancement with the release of version 0.3.2. Address rewriting has always been a highly requested feature, and we've..."
authors: [mdecimus]
tags: [address, envelope, rewrite, smtp]
excerpt: "Stalwart Mail Server continues its tradition of constant innovation and advancement with the release of version 0.3.2. Address rewriting has always been a highly requested feature, and we've delivered in a big way. The 0.3.2 update introduces [sender and recipient address rewriting](/docs/mta/rewrite/address) using both regular expressions and Sieve scripts. This means you now have the ability to manipulate and manage email addresses like never before, providing unparalleled flexibility in routing your emails."
date: 2023-07-28
---
