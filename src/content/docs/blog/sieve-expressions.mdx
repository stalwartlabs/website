...
description: "Today we are announcing the latest release of Stalwart Mail Server: version 0.3.6. This update includes multiple enhancements to the Sieve filtering language, including the ability to evaluate..."
authors: [mdecimus]
...
To learn more about expressions in Sieve scripts, check out the [Arithmetical and Logical Expressions](/docs/sieve/) section in the documentation.
...
To learn more about fetching data from SQL or LDAP queries, check out the [query extension](/docs/sieve/) documentation.
