...
description: "Building and sending e-mails securely does not have to be complicated. Today the mail-send crate was released including the following features:"
authors: [mdecimus]
