---
title: Parsing E-mail messages in Rust
description: "Today we released mail-parser, an e-mail parsing library written in Rust that fully conforms to the Internet Message Format standard (RFC 5322), the Multipurpose Internet Mail Extensions (MIME; RFC..."
authors: [mdecimus]
tags: [rust, email, mime, parse]
excerpt: "Today we released mail-parser, an e-mail parsing library written in Rust that fully conforms to the Internet Message Format standard (RFC 5322), the Multipurpose Internet Mail Extensions (MIME; RFC 2045–2049) as well as other internet messaging RFCs."
date: 2021-11-02
---
It also supports decoding messages in [41 different character sets](https://github.com/stalwartlabs/mail-parser#supported-character-sets) including obsolete formats such as UTF-7. All Unicode (UTF-*) and single-byte character sets are handled internally by the library while support for legacy multi-byte encodings of Chinese and Japanese languages such as BIG5 or ISO-2022-JP is provided by the optional dependency [encoding_rs](https://crates.io/crates/encoding_rs).
...
* Every function in the library has been [fuzzed](https://github.com/stalwartlabs/mail-parser#testing-fuzzing--benchmarking) and meticulously [tested with MIRI](https://github.com/stalwartlabs/mail-parser#testing-fuzzing--benchmarking).
...
The mail-parser library is available on Crates.io ([https://crates.io/crates/mail-parser](https://crates.io/crates/mail-parser)) and the documentation at [https://docs.rs/mail-parser/](https://docs.rs/mail-parser/).

Please [follow us on Twitter](https://twitter.com/stalwartlabs) for updates!
