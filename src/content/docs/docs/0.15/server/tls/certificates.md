...
When TLS certificates are updated, it is necessary to reload them in order for the changes to take effect. This can be done without stopping the server by using the [web-admin](/docs/0.15/management/webadmin/) or [command line interface](/docs/management/cli/).
