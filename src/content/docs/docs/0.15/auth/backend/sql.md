...
- `secret`: Maps to the 'secret' column in the SQL database. Passwords can be stored [hashed](/docs/0.15/auth/authentication/password) or in plain text (not recommended).
