...
- **picture**: A URL that points to the logo associated with this domain. When administrators or users access the [web administration interface](/docs/0.15/management/webadmin/) for this domain, the specified logo is displayed as part of the branding. This feature allows each domain to have a custom look and feel, making it easier to identify and manage in multi-domain environments.
