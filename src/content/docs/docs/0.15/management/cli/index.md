...
Although the recommended way to manage and configure Stalwart is using the [web-admin](/docs/0.15/management/webadmin/), the CLI tool can be useful for automating tasks or performing some operations that are not available in the web interface.
