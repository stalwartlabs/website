...
The backup procedure for Stalwart varies depending on the chosen [storage](/docs/storage/) backend. Ensuring regular backups of your data will minimize the risk of data loss and aid in recovery in case of accidental deletion or system failures.
