...
- [Sieve scripts](/docs/sieve/): These are scripts written in the Sieve language, a powerful, yet straightforward language specifically designed for mail filtering. Sieve scripts allow both [administrators](/docs/sieve/) and [users](/docs/sieve/managesieve) to specify rules for how incoming mail should be handled.
