...
Please refer to the [Sieve scripting](/docs/sieve/) section for more information about the Sieve scripting language and how to configure the Sieve interpreter.
