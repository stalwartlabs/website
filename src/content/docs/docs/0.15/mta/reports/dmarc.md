...
- `sign`: The list of [DKIM](/docs/mta/authentication/dkim/) signatures to use when signing the DMARC report.
...
- `sign`: The list of [DKIM](/docs/mta/authentication/dkim/) signatures to use when signing the DMARC aggregate report.
