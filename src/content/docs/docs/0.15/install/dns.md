...
[DomainKeys Identified Mail (DKIM)](/docs/mta/authentication/dkim/) adds a digital signature to outgoing emails to prove they originated from your domain and haven’t been altered in transit. DKIM uses TXT records that publish public keys used to verify these signatures.
