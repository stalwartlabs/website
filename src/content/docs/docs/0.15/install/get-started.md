...
We begin with an overview of [System Requirements](/docs/install/requirements), where you’ll learn how memory and CPU usage scale with server load and how to size your system accordingly. The [Installation Guide](/docs/0.15/install/) provides instructions for setting up Stalwart on your platform of choice, including details on configuration.
