...
The license is stored on the [Enterprise](/docs/ref/object/enterprise) singleton (found in the WebUI under <!-- breadcrumb:Enterprise --><svg class="lucide-icon" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><path d="M10 5H3" /><path d="M12 19H3" /><path d="M14 3v4" /><path d="M16 17v4" /><path d="M21 12h-9" /><path d="M21 19h-5" /><path d="M21 5h-7" /><path d="M8 10v4" /><path d="M8 12H3" /></svg> Settings › <svg class="lucide-icon" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 9.9-1" /></svg> Enterprise<!-- /breadcrumb:Enterprise -->) through [`licenseKey`](/docs/ref/object/enterprise#licensekey). The field is a secret: it can hold the literal license string, or point at an environment variable or a file.
...
After the license key is saved, the server configuration must be reloaded from the [CLI](/docs/management/cli/). Logging out and back in is required before the Enterprise features become visible in the session.
