...
When a certificate file is rotated on disk, the running server needs to be told to re-read it. This can be triggered without stopping the server from the [WebUI](/docs/management/webui/) or the [CLI](/docs/management/cli/).
