...
This method requires the `sysSieveSystemScriptGet` [permission](/docs/ref/permissions).
...
This operation requires the `sysSieveSystemScriptCreate` [permission](/docs/ref/permissions).
...
This operation requires the `sysSieveSystemScriptUpdate` [permission](/docs/ref/permissions).
...
This operation requires the `sysSieveSystemScriptDestroy` [permission](/docs/ref/permissions).
...
This method requires the `sysSieveSystemScriptQuery` [permission](/docs/ref/permissions).
