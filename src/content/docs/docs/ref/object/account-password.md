...
> Type: [<code>OtpAuth</code>](#otpauth) · required
>
...
This method requires the `sysAccountPasswordGet` [permission](/docs/ref/permissions).
...
This method requires the `sysAccountPasswordUpdate` [permission](/docs/ref/permissions).
