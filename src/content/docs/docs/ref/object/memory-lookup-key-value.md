...
This method requires the `sysMemoryLookupKeyValueGet` [permission](/docs/ref/permissions).
...
This operation requires the `sysMemoryLookupKeyValueCreate` [permission](/docs/ref/permissions).
...
This operation requires the `sysMemoryLookupKeyValueUpdate` [permission](/docs/ref/permissions).
...
This operation requires the `sysMemoryLookupKeyValueDestroy` [permission](/docs/ref/permissions).
...
This method requires the `sysMemoryLookupKeyValueQuery` [permission](/docs/ref/permissions).
