---
title: TracingStore
description: Configures the storage backend for tracing data.
...
This method requires the `sysTracingStoreGet` [permission](/docs/ref/permissions).
...
This method requires the `sysTracingStoreUpdate` [permission](/docs/ref/permissions).
...
```sh
stalwart-cli update TracingStore --field description='updated value'
```
