...
This method requires the `sysApplicationGet` [permission](/docs/ref/permissions).
...
This operation requires the `sysApplicationCreate` [permission](/docs/ref/permissions).
...
This operation requires the `sysApplicationUpdate` [permission](/docs/ref/permissions).
...
This operation requires the `sysApplicationDestroy` [permission](/docs/ref/permissions).
...
This method requires the `sysApplicationQuery` [permission](/docs/ref/permissions).
