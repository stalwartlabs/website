...
> Type: [<code>MetricType</code>](/docs/ref/metrics) · required
>
> Metric event type
...
This method requires the `sysMetricGet` [permission](/docs/ref/permissions).
...
This operation requires the `sysMetricCreate` [permission](/docs/ref/permissions).
...
This operation requires the `sysMetricUpdate` [permission](/docs/ref/permissions).
...
This operation requires the `sysMetricDestroy` [permission](/docs/ref/permissions).
...
This method requires the `sysMetricQuery` [permission](/docs/ref/permissions).
