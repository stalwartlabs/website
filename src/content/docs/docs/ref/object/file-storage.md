...
This method requires the `sysFileStorageGet` [permission](/docs/ref/permissions).
...
This method requires the `sysFileStorageUpdate` [permission](/docs/ref/permissions).
