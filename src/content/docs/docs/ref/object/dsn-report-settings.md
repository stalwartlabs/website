...
>
> Available variables: [`MtaQueueSenderVariable`](/docs/ref/expression/variable/mta-queue-sender-variable).
...
This method requires the `sysDsnReportSettingsGet` [permission](/docs/ref/permissions).
...
This method requires the `sysDsnReportSettingsUpdate` [permission](/docs/ref/permissions).
...
- [`MtaQueueSenderVariable`](/docs/ref/expression/variable/mta-queue-sender-variable) (Variables)
