...
This method requires the `sysSpfReportSettingsGet` [permission](/docs/ref/permissions).
...
This method requires the `sysSpfReportSettingsUpdate` [permission](/docs/ref/permissions).
