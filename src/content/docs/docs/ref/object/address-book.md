...
> Type: <code>String?</code> · default: `"Stalwart Address Book"`
>
...
This method requires the `sysAddressBookGet` [permission](/docs/ref/permissions).
...
This method requires the `sysAddressBookUpdate` [permission](/docs/ref/permissions).
