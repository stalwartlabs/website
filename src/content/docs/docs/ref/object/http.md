...
> Type: [<code>Expression</code>](#expression) · default: `{"else":"200"}`
>
...
>
> Available variables: [`HttpVariable`](/docs/ref/expression/variable/http-variable).
...
This method requires the `sysHttpGet` [permission](/docs/ref/permissions).
...
This method requires the `sysHttpUpdate` [permission](/docs/ref/permissions).
...
- [`HttpVariable`](/docs/ref/expression/variable/http-variable) (Variables)
