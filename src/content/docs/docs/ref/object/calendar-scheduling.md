...
This method requires the `sysCalendarSchedulingGet` [permission](/docs/ref/permissions).
...
This method requires the `sysCalendarSchedulingUpdate` [permission](/docs/ref/permissions).
