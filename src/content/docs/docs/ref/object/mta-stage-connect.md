...
> Type: [<code>Expression</code>](#expression) · default: `{"else":"system('hostname') + ' Stalwart ESMTP at your service'"}`
>
...
> Type: [<code>Expression</code>](#expression) · default: `{"else":"system('hostname')"}`
>
...
This method requires the `sysMtaStageConnectGet` [permission](/docs/ref/permissions).
...
This method requires the `sysMtaStageConnectUpdate` [permission](/docs/ref/permissions).
