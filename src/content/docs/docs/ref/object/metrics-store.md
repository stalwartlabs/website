...
This method requires the `sysMetricsStoreGet` [permission](/docs/ref/permissions).
...
This method requires the `sysMetricsStoreUpdate` [permission](/docs/ref/permissions).
