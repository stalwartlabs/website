...
This method requires the `sysSharingGet` [permission](/docs/ref/permissions).
...
This method requires the `sysSharingUpdate` [permission](/docs/ref/permissions).
