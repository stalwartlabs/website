---
title: DnsServerBootstrapType
description: DnsServerBootstrapType enumeration reference.
...
| Value | Label |
|---|---|
| `Manual` | Manual DNS server management |
| `Tsig` | RFC2136 (TSIG) |
| `Deprecated1` | RFC2136 (SIG0 - deprecated) |
...
| `Autodns` | InterNetX AutoDNS |
| `AzureDns` | Microsoft Azure DNS |
| `BaiduCloud` | Baidu Cloud DNS |
| `BluecatV2` | BlueCat Address Manager |
| `ClouDns` | ClouDNS |
