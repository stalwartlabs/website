...
- **lists**: Lists the [mailing lists](/docs/email/management/mailing-lists) that the account is subscribed to or a member of. This allows the account to receive messages sent to specific mailing lists.
