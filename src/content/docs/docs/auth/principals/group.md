...
- **lists**: Lists the [mailing lists](/docs/email/management/mailing-lists) the group is a member of. This allows the group to receive messages sent to those mailing lists.
