...
Users can enable Two-Factor Authentication on their accounts from the [self-service portal](/docs/management/webui/). Inside the portal, the Two-factor Authentication page presents a TOTP QR code that the user scans with an authenticator app, linking the account to the app.
