...
Users create and remove Application Passwords from the [self-service portal](/docs/management/webui/), under the App Passwords menu option. The portal lists existing Application Passwords and allows individual entries to be revoked.
