...
- [`failureDkimSignDomain`](/docs/ref/object/dmarc-report-settings#failuredkimsigndomain): expression returning the domain whose [DKIM](/docs/mta/authentication/dkim/) signatures sign the outgoing report. Default `system('domain')`.
