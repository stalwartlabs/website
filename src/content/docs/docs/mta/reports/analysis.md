...
- [`inboundReportAddresses`](/docs/ref/object/report-settings#inboundreportaddresses): set of addresses (with optional wildcards) from which reports are intercepted and analysed. These addresses must be routable. Default `{"postmaster@*": true}`.
