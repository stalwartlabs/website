...
- [Sieve scripts](/docs/sieve/): scripts written in the Sieve language, a standard scripting language for mail filtering. Sieve scripts let administrators and users specify rules for handling incoming mail.
