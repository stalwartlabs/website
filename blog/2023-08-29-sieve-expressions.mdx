...
To learn more about expressions in Sieve scripts, check out the [Arithmetical and Logical Expressions](/docs/sieve/overview) section in the documentation.
...
To learn more about fetching data from SQL or LDAP queries, check out the [query extension](/docs/sieve/overview) documentation.
